...
<html>
	...
	<header class="site-header">
		<div class="contenedor">
			<div class="barra">
				<a href="panelPaciente.php"><img src="img/Logotipo.png" alt="Logo"></a>
				<div class="user">
    ...
    <main class="contenedor">
        <p id="folio">Número de Expediente: <?php obtenerNumExpediente($_SESSION['idPaciente'],$conection); ?></p>
        <form action="Funciones/actualizarInfo.php" class="Cuerpo" method="POST">
            <h3>Datos Personales</h3>
            <div class="formulario">
                <div class="col">
                     Primer nombre y apellidos<br>
                    <input type="text" readonly name="nombre" value="<?php obtenerNombre($_SESSION['idPaciente'], $conection); ?>"><br>
                    <br>Fecha de Nacimiento<br>
                    <input type="date" readonly name="fechanac" value="<?php obtenerFechaNac($_SESSION['idPaciente'], $conection);?>""><br>
                </div>
                <div class="col">
                    Género<br>
                    <input type="text" readonly name="genero" value="<?php obtenerGenero($_SESSION['idPaciente'], $conection);?>"><br>
                    <br>Peso (Kg)<br>
            ...
            <div>
                ...
                <?php obtenerConsultaspaciente($_SESSION['idHistorial'], $conection);?>
            </div>
